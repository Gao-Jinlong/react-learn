...
const PixiGraphics = () => {
  ...
  async function init() {
    ...
    const target = document.getElementById('pixi-graphics-container');
    ...
    // 创建一个 Graphics 对象用作 mask 在多个子元素上切换
  ...
  return <div id="pixi-graphics-container"></div>;
};
